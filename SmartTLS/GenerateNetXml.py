...
print('    <tlLogic id="nd0" type="static" programID="1" offset="0">', file = nodes)
print('        <phase duration="40" state="GrGr"/>', file = nodes)
print('        <phase duration="3"  state="yryr"/>', file = nodes)
print('        <phase duration="15" state="rGrG"/>', file = nodes)
print('        <phase duration="3"  state="ryry"/>', file = nodes)
print('    </tlLogic>', file = nodes)
